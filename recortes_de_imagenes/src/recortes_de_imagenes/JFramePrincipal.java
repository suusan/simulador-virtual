  ...
  //abre una ventana de dialogo para escoger la direccion y el nombre del archivo a guardar
   ...
   JInternalFrame frame=new JInternalFrame();
    ...
    private void initComponents() {
        ...
        label1.setForeground(new java.awt.Color(255, 153, 255));
        label1.setName(""); // NOI18N
        label1.setText("Provador de  Cortes");
        ...
        jButton1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/recortes_de_imagenes/chicas.JPG"))); // NOI18N
